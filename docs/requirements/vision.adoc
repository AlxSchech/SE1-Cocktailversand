...
[cols="1,3"]
|===
|Das Problem |	Einen Online-Shop in einer Webseite entwickeln
...
|Barbetreiber	| | Dieser Stackeholder sorgt für die Bearbeitung einer Bestellung
|Kunde | Über Kundenkonten verwaltete Kunden | Diese geben Bestellung auf
|Gesetzgeber | extern, nicht an Kaufprozess beteiligte Instanz | Gibt Richtlinien zum Produktverkauf, erlaubte Zutaten, Kundenschutz, Betriebsrechte an
| Versandunternehemen | | (zu klären im Scope)  je nach evtl. ergebene Abhängigkeiten  vom Satkeholder
| Lieferant | | Bestimmt durch Belieferungsabhängigkeiten Preise, Angebote, je nach evtl. ergebene Abhängigkeiten  vom Satkeholder
| Web-Hosting | (IT-Betrieb) | Benutzerumgebungen (Up-time , Reaktionsgeschw.), Backup
| Zahlungsdienstleister | z.B. PayPal, Bank | Bestimmt die Zahlungsart
|===
...
//Zutreffendes angeben, nicht zutreffendes streichen oder auskommentieren
// Wie schnell muss die Seite laden (noch zu klären)
Hinweise:
